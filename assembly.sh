...
samtools view -Fh 2048 $3_bam/$4.bam | samtools view -ShF 1024 - | samtools view -ShF 512 - | samtools view -SF 256 - | awk '{print ">"$1"\n"$10}' > $3_fasta/$4.fasta
samtools view -Fh 2048 $3_bam/$4.bam | samtools view -ShF 1024 - | samtools view -ShF 512 - | samtools view -SF 256 - | grep "SA:Z:" > $3_fasta/$4_presplits.sam
...
python consensus.py $3_fasta/$4_splits.sam ??? > $3_fasta/consensus.fa
...
jesper.fasta >> $3_assembly/$4_merged.contig.fa
